...
input_new_contact = ['Введите имя контакта: ',
                     ...
                     'Введите комментарий дял контакта: ']
...
input_serch_word_for_edit = 'Введите слово для поиска контакта, который хотите изменить:'
input_serch_word_for_delete = 'Введите слово для поиска контакта, который хотите удалить:'
